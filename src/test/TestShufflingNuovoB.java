...
public class TestShufflingNuovoB{
  ...
  //diverse modalità di esecuzione (random, self80-20, ecc)
    ...
    public static void main(String[] args) throws Exception {
       ...
       // int[] phisical = new int[NUMNODE];
        ...
        {         
                int cont = 0;
                FileReader fr = new FileReader("C:/Users/Riccardo Moretti/Desktop/test/SequenzaAccessi"+j+".txt"); 
                BufferedReader br = new BufferedReader(fr); 
                String s; 
                
                while((s = br.readLine()) != null) {                 
                    seqAccessMem[j][cont] = Integer.parseInt(s);   
                    cont++;       
                } 
           ...
           for (int i = 0; i < NUMNODE; i++)
            ...
            for (int i = 0; i < NUMACCESS; i++) 
             ...
             for (int i = 0; i < NUMACCESS; i++) { 
                ...
                {
                    if(accres.logical[b] == 1)
                        logical[b]++;
                    if(accres.phisical[b] == 1)
                        phisical[b]++;                      
                }                                
            }
